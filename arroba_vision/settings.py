"""
Django settings for arroba_vision project.
...
SECRET_KEY = 'django-insecure-$vp5xi&3x#=pj9gl+2(z*n*5q7prrg%&a7985-l*(^300x*v*h'
...
ROOT_URLCONF = 'arroba_vision.urls'
...
WSGI_APPLICATION = 'arroba_vision.wsgi.application'
